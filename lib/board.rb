...
module BoardHelper
  ...
  # Adjusted color symbol from :ash to :light_black
  MOVES_HOLDER = "\u00b0".colorize(:light_black)
end
...
class Board
  ...
  # Updates the feedback section of the board with feedback for the current
  # guess.
  #
  # This method generates feedback for the most recent guess and updates the
  # board. It creates an array of feedback symbols, then randomly samples 4 of
  # these symbols to update the feedback section of the board.
  #
