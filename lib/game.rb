...
class Game
  ...
  def display_board(msg: nil)
    ...
    msg = "Code maker's secret: #{board.reveal_secret_code}\n\n"

    puts msg if human_code_maker?
  end
    ...
    def play_round
      while board.moves_used < Board.moves_allowed
        ...
        begin
          ...
          error = "Your guess #{guess} has invalid colors: Try again"
                  .colorize(:red)
        end

        display_board(msg: error) if human_code_maker?
